...
function DisplayShopPrices() {
  ...
  return (
    <div>
      ...
      {/* Display Total Daily Prices Button */}
      <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '10px' }}>
        <Link to="/totalShopPrices" style={{ textDecoration: 'none' }}>
          <StyledButton variant="contained" color="secondary">
            Display Total Daily Prices
          </StyledButton>
        </Link>
      </div>
          ...
          <TableBody>
            {ShopPrices && ShopPrices.map((shopproductprices, i) => (
              <TableRow key={i} style={{ backgroundColor: i % 2 === 0 ? '#f2f2f2' : 'white', color: "black" }}>
                ...
                <StyledTableCell2>{shopproductprices.spApple}</StyledTableCell2>
                <StyledTableCell2>{shopproductprices.spOrange}</StyledTableCell2>
                <StyledTableCell2>{shopproductprices.spBanana}</StyledTableCell2>
                <StyledTableCell2>{shopproductprices.spGraphes}</StyledTableCell2>
                <StyledTableCell2>{shopproductprices.spWatermelon}</StyledTableCell2>
                <StyledTableCell2>{shopproductprices.spMango}</StyledTableCell2>
                <StyledTableCell2>{shopproductprices.spWoodapple}</StyledTableCell2>
                <StyledTableCell2>{shopproductprices.spPineapple}</StyledTableCell2>
                <StyledTableCell2>{shopproductprices.spPapaya}</StyledTableCell2>
                <StyledTableCell2>{shopproductprices.spGoava}</StyledTableCell2>
                <StyledTableCell>
