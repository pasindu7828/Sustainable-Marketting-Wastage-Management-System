...
function TotalShopPrices() {
  ...
  const fruits = ['apple', 'orange', 'banana', 'graphes', 'watermelon', 'mango', 'woodapple', 'pineapple', 'papaya', 'goava'];

  return (
    <div>
      <ByProductNav />
      
      {/* Button to navigate to Summary Page - placed at the top of the table */}
